<?php
    ...
    function logHistory($symbol, $price, $quantity, $type, $id) {
        CS50::query("INSERT INTO history (user_id, symbol, price, quantity, type, created)".
        "VALUES(?, ?, ?, ?, ?, NOW())",
        $id, strtoupper($symbol), $price, $quantity, $type);
    }
